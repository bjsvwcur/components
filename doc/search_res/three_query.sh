...
--data-urlencode "OR ( (search_2_stem:$1^4 OR search_2_ngram:$1^3) AND (search_2_stem:$2^4 OR search_2_ngram:$2^3) AND (search_2_stem:$3^4 OR search_2_ngram:$3^3) )" \
--data-urlencode "OR ( (search_3_stem:$1^2 OR search_3_ngram:$1^1) AND (search_3_stem:$2^2 OR search_3_ngram:$2^1) AND (search_3_stem:$3^2 OR search_3_ngram:$3^1) )" \
